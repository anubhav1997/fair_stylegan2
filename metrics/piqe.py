...
class piqe(metric_base.MetricBase):
...
#         niqe_metric = niqe_()
        piqe_metric = create_metric('piqe', test_y_channel=True, color_space='ycbcr', device=torch.device("cpu"))
...
#                 images = images.numpy()
        ...
        for begin in range(0, self.num_images, minibatch_size):
            ...
            for i in range(len(out)):
                ...
                quality = piqe_metric(out2, None).cpu()
